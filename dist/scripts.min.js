...
angular.module("whatToDo.directives", []).directive("appVersion", [ "version", function(a) {
...
}), angular.module("whatToDo.filters", []).filter("interpolate", [ "version", function(a) {
    return function(b) {
    ...
    a.app = {
        ...
        a.questionUrl = window.location.origin + "/#/q/" + b, angular.element("#fb-share").attr("data-href", a.questionUrl), 
    ...
    b.soundFinish = "./sounds/end.wav", b.loadingQuestion = !1, b.init = function(a) {
        ...
        b.canvas.width = b.canvasSize.width, b.canvas.height = b.canvasSize.height, a.showTooltips = !1, 
        b.chart = new Chart(b.context).Doughnut(b.items, a);
        ...
        a.questionObject.isLiked = b, a.saveQuestionToDB(a.questionObject);
        ...
        angular.element("#loading-question").slideUp(), c(function() {
            b.$apply(function() {
                b.loadingQuestion = !1, b.question = d.text, b.data = d.options, b.prepareChoices(), 
                b.drawChart({
                    animateRotate: !1,
                    animateScale: !0
                }), b.divResult.addClass("animation-once"), b.divResult.addClass("bounceIn");
                var a = angular.element("#resultBadge"), c = angular.element("#resultName");
                a.css("background-color", d.answer.color), a.text(d.answer.badge), c.text(d.answer.name), 
