...
angular.module("whatToDo.directives", []).directive("appVersion", [ "version", function(a) {
    ...
    b.soundFinish = "./sounds/end.wav", b.loadingQuestion = !1, b.init = function(a) {
        ...
        b.canvas.addClass("disable-animation"), b.setRotation("rotate(0deg)"), b.resetDivResult(), 
        b.drawChart({
            animateRotate: !1,
            animateScale: !0
        });
        ...
        1 === a ? b.divAnswer.slideDown() : b.divAnswer.slideUp();
        ...
        if (0 !== b.data.length) {
            ...
            var e = b.getRandom(b.items.length);
            e = 5 > e ? 10 : e;
            var f = 360 * e, g = f, h = "rotate(" + g + "deg)";
            b.canvas.removeClass("disable-animation"), b.setRotation(h), b.askButton = !1, b.askResult = !0, 
            b.musicRotate.play();
            var i = 0;
            b.rotateInterval = d(function() {
                i = i >= b.items.length ? 0 : i;
                var a = b.items[i].color;
                b.divResult.css("background-color", a), i++;
            }, 500), c(function() {
                b.musicFinish.play(), d.cancel(b.rotateInterval);
                var e = b.getRandom(b.data.length), f = b.items[e].color, g = b.items[e].id;
                b.showResultCircle(g, f), b.divResult.addClass("animation-once"), b.divResult.addClass("bounceIn");
                var h = angular.element("#resultBadge"), i = angular.element("#resultName");
                h.css("background-color", f), h.text(b.items[e].id), i.text(b.items[e].name), c(function() {
                    b.changeAnswerDivVisibility(1);
                }, 1e3);
                var j = new Date();
                a.questionObject = {
                    text: b.question,
        ...
        a.questionObject = {
            ...
            isLiked: [ -1 ],
            isLikedAdded: -1
        }, b.getCollorPalette(), b.resetDivResult(), b.changeAnswerDivVisibility(0), b.drawChart({}), 
        b.showResultCircle("?", "#333333"), a.buttonAsk();
    }, b.resetDivResult = function() {
        b.divResult.removeClass("animation-once"), b.divResult.removeClass("bounceIn");
